...
(2, 1, 'owner@gmail.com', '1692103408.jpeg', 'We have recently added swimming pool too for Annual Plan', '12-Aug-2023', '1692103408.jpeg', 'Now monthly plan is cheapest from ever.', '1692103408.jpeg', 'What are you waiting for go for annual plan for additional benifits', '1692103408.jpeg', 'We are here to help u 24/7...');
...
(1, 'owner', 'Gold Gym', 'Thrissur', 'owner@gmail.com', 'www.goldgym.com', 'Women', '1234567890', 'Thrissur,Mg Kavu,opp KILA Kerala -680581', 'A health club (also known as a fitness club, fitness center, health spa, weight room and commonly referred to as a gym) is a place that houses exercise equipment for the purpose of physical exercise. In recent years, the number of fitness and health services have increased, expanding the interest among the population. Today, health clubs and fitness centers are a reference of health services', '500', '6000', 'owner', '1691411916.jpeg', '1691411916.jpg', 'Admin', 'Approved'),
...
INSERT INTO `payment` (`payment_id`, `owner_id`, `holder_name`, `card_no`, `exp_month`, `exp_year`, `cvv`, `amount`, `status`, `plan`) VALUES
(3, 2, 'user', '1234567899', 'Jan', '2023', '123', '700', 'Paid', 'Monthly'),
(4, 1, 'user2', '4646415123123', 'Aug', 'year', '125', '6000', 'Paid', 'Annual');
