	...
	<div class="main-content">
            ...
            <div class="navbar-collapse">
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left cbp-spmenu-open" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
						<li>
							<a href="myprofile.php" class="active"><i class="fa fa-home nav_icon"></i>My Profile</a>
						</li>
						<li>
							<a href="approve_gym.php"><i class="fa fa-cogs nav_icon"></i>Approve Gyms</a>
						...
						<li class="">
							<a href="gym_registration.php"><i class="fa fa-book nav_icon"></i>Add Gyms</a>
							
							<!-- /nav-second-level -->
						</li>
						
						<li>
							<a href="pending_complaints.php"><i class="fa fa-cogs nav_icon"></i>Pending Complaints/Suggestions</span></a>
							
						</li>
								<li><a href="all_complaints.php"><i class="fa fa-cogs nav_icon"></i>All_complaints</a>
								</li>
								<li><a href="logout.php"><i class="fa fa-cogs nav_icon"></i>Log Out<span></span></a>
								</li>
						<!-- <li>
		...
		<div class="sticky-header header-section ">
			<div class="header-left">
				<!--toggle button start-->
				<button id="showLeftPush" class="active"><i class="fa fa-bars"></i></button>
				<!--toggle button end-->
				<!--logo -->
				<div class="logo">
					<a href="#">
