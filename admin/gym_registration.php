  ...
  <div class="panel-body">
          <form role="form" class="form-horizontal" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label class="col-md-2 control-label">Owner Full Name</label>
              <div class="col-md-8">
    ...
    if (isset($_POST['button'])) 
    {
        ...
        {  
          ...
          { 
                ...
                {
                  move_uploaded_file($_FILES['img1']['tmp_name'], '../gym_owner/images/'.$photo1);
                    
                    if (in_array($extn2,$allowextn2)) 
                    {
                              move_uploaded_file($_FILES['img2']['tmp_name'], '../gym_owner/images1/'.$photo2);
                          ...
                          values('$name','$gymname','$location','$email','$website','$gender','$mobile','$address','$description','$monthly','$annual','$password','$photo1','$photo2','Admin','Approved')";
                           ...
                           if ($execute1) 
                            {
                              ...
                              echo "<script>window.location.href='gym_registration.php'</script>";
                            }
                            else
                            {
