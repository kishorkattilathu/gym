					...
					<form class="" method="post" action="#">
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-envelope fa" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="mobile" required="" id="mobile"  placeholder="Enter your mobile no:"/>
								</div>
							</div>
						</div>
						...
						<div id="register-link" class="text-right">
                                <a href="../user/index.php" class="text-info">Home  &nbsp; &nbsp;</a>
                                <a href="owner_login.php" class="text-info">Already Registered ?</a>
                            </div>
					</form>
				</div>
			</div>
...
if (isset($_POST['button'])) 
		{
			...
			if ($password==$confirm) 
			{
				...
				if ($count==0) 
				{
					$insert="INSERT INTO gym_owner(owner_name,owner_email,password,mobile,owner_type,owner_status) values('$name','$email','$password','$mobile','Gym_owner','Pending')";
