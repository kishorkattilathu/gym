  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="table-responsive" id="" class="text-center">
            <label class="text-center"><h3 class="text-center">Approved Bookings</h3></label><br>
                <table id="sailorTable" class="table table-striped table-bordered text-center" width="150%">
                        ...
                        <tbody>
                        	<?php
								include '../connect.php';
								$select="SELECT * FROM booking inner join trainees on trainees.trainee_id=booking.trainee_id WHERE booking_status='Approved' and trainees.owner_email='$mail'";
