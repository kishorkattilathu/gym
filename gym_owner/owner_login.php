...
<body>
    <div id="login">
        <h3 class="text-center text-white pt-5">Gym Owner Login form</h3>
        <div class="container">
                    ...
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" method="post">
                            ...
                            <div id="register-link" class="text-right">
                                ...
                                <a href="owner_register.php" class="text-info">Register here</a>
                            </div>
                        </form>
                    </div>
                </div>
...
if (isset($_POST['button'])) 
	{
		...
		$select="SELECT * FROM gym_registration WHERE gym_email='$email' AND password='$password' AND status='Approved'";
